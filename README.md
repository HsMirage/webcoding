...
[简体中文](./README.md) | [English](./README.en.md) | [v2.0.9 发布说明](https://github.com/HsMirage/webcoding/releases/tag/v2.0.9) | [更新日志](./CHANGELOG.md)
...
> `v2.0.9` 为提供商设置新增模型列表与上下文长度，并修正本地/自定义渠道的 `/model` 来源；Claude 自定义模型默认启用 `[1m]` 长上下文模式。
...
- [v2.0.9 发布说明](https://github.com/HsMirage/webcoding/releases/tag/v2.0.9)
- [完整更新日志](./CHANGELOG.md)
