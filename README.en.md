...
[简体中文](./README.md) | [English](./README.en.md) | [v2.1.0 release notes](https://github.com/HsMirage/webcoding/releases/tag/v2.1.0) | [Changelog](./CHANGELOG.md)
...
> `v2.1.0` adds full Chat Completions, Responses, and Anthropic Messages compatibility, verified across all nine Claude Code, Codex, and Pi protocol combinations.
...
- [v2.1.0 release notes](https://github.com/HsMirage/webcoding/releases/tag/v2.1.0)
