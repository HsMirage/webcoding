...
[简体中文](./README.md) | [English](./README.en.md) | [v2.0.0 release notes](https://github.com/HsMirage/webcoding/releases/tag/v2.0.0) | [Changelog](./CHANGELOG.md)
...
> `v2.0.0` uses three native bidirectional transports by default: Claude `stream-json`, Codex App Server, and Pi RPC. Legacy one-shot transports remain available through environment variables.
...
- [v2.0.0 release notes](https://github.com/HsMirage/webcoding/releases/tag/v2.0.0)
